 ...
 */
public final class SeekTsExtractor implements Extractor, SeekMap {

    final String TAG = SeekTsExtractor.class.getName();

    /**
     * Factory for {@link SeekTsExtractor} instances.
     */
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() {

        @Override
        public Extractor[] createExtractors() {
            return new Extractor[]{new SeekTsExtractor()};
        }
    ...
    public SeekPoints getSeekPoints(long timeUs) {
        SeekPoint seekPoint = new SeekPoint(timeUs, getPosition(timeUs));
     ...
     */
    public SeekTsExtractor(@Flags int defaultTsPayloadReaderFlags) {
     ...
     *                                    {@code FLAG_*} values that control the behavior of the payload readers.
     */
    public SeekTsExtractor(@Mode int mode, @Flags int defaultTsPayloadReaderFlags) {
     ...
     */
    public SeekTsExtractor(@Mode int mode, TimestampAdjuster timestampAdjuster,
    ...
    public int read(ExtractorInput input, PositionHolder seekPosition)
        ...
        Log.i("TAG", "position: " + input.getPosition() + " seekPosition: " + seekPosition.position);
        byte[] data = tsPacketBuffer.data;
        if (duration == Long.MIN_VALUE) {
            duration = input.getLength();
        }
